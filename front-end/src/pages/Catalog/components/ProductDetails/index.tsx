...
import { ReactComponent as ProdutcImage } from '../../../../core/assets/images/product.svg';
...
const ProductDetails = () => {
    ...
    const { producId } = useParams<ParamsType>();    
              ...
              <div className="row">
                  <div className="col-6 pr-5">
                      <div className="product-details-card text-center">
                          <ProdutcImage className="product-details-image"/>
                      </div>
